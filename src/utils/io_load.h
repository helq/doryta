#ifndef DORYTA_UTILS_IO_LOAD_H
#define DORYTA_UTILS_IO_LOAD_H

/** @file
 * _DEFAULT_SOURCE MUST be defined before including this file; in fact, it
 * must be defined on top of the file including this file.
 *
 * This file requires to set the preprocessor variable _DEFAULT_SOURCE in order
 * to activate a set of nonstandard macros: be16toh, be32toh and be64toh.
 */


// Just for redundancy's sake, but it is only useful when this file is included
// first
