...
int main(int argc, char *argv[]) {
    ...
    // Defining neurons
    // GoL board
    layout_master_neurons(252, 0, last_node);  // 12 x 21
    ...
    layout_master_synapses_conv2d(0, 251, 252, 252 + 28-1,  &conv2d_params);
    ...
    if (g_tw_mynode == 0) {
        ...
        spikes[0] = calloc(6, sizeof(struct StorableSpike));
        ...
        spikes[2] = spikes[0] + 4;
        spikes[2][0] = (struct StorableSpike){
            .neuron = 2, .time = 0.8, .intensity = 101 };
    }
